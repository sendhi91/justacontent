...
const Hero = () => {
  ...
  <div className="relative w-80 h-80 md:w-[28rem] md:h-[28rem] rounded-full overflow-hidden shadow-2xl ring-8 ring-white/20">
  <motion.img
  src={profileImage}
  alt="Albertus Sendhi"
  className="w-full h-full object-cover"
  style={{ objectPosition: 'center 40%' }}  // posisi turun lebih ke tengah
