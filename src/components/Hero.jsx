...
const Hero = () => {
  ...
  const handleGoDeeper = () => {
    ...
    setTimeout(() => navigate('/about'), 500); // Match this duration with your transition
  };

  return (
    <section 
      id="home"
      className="min-h-screen flex items-center justify-center px-4 transition-colors duration-300 hero-section"
      style={{
        background: darkMode 
    ...
    >
      <div className="hero-content text-center max-w-4xl mx-auto transition-opacity duration-500">
        <motion.div
